          ...
          <div class="pad">
            <div class="wrapper pad_bot1">
              <p class="cols pad_bot2"><strong>Name:<br>
                ...
                Profession:<br>
                Email:</strong></p>
              <p class="color1 pad_bot2">LUTALO ERISA<br>
                KAMPALA<br>
                STUDENT AT SLAU</p>
              <p class="color1 pad_bot2"><a href="#">elijosaiah77@gmail.com</a></p>
              <p><figure><img src="images/20151012_134011.jpg"  alt="" width="100%";></figure></p>
            </div>
          </div>
